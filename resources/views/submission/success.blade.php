        ...
        <div class="max-w-2xl w-full">
            ...
            <div class="bg-[#232528]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden group mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-gradient-to-r from-red-600 to-[#A3050A] text-white font-bold hover:scale-[1.02] transition-all shadow-[0_0_20px_rgba(163,5,10,0.3)]">
                ...
                <script>
                    function downloadSlip() {
                        ...
                        iframe.src = "{{ route('submission.packingSlip.download', $submission->id) }}";
                    }
                </script>
            </div>
