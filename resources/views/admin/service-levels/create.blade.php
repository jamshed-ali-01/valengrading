    ...
    <div class="bg-[#232528]/80 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl">
        <form method="POST" action="{{ route('admin.service-levels.store') }}" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" id="delivery_time" name="delivery_time" value="{{ old('delivery_time') }}" 
                    class="w-full bg-[#15171A] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-red-500 transition-colors"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="number" id="min_submission" name="min_submission" value="{{ old('min_submission') }}" 
                        class="w-full bg-[#15171A] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-red-500 transition-colors"
                        placeholder="None">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" step="0.01" id="price_per_card" name="price_per_card" value="{{ old('price_per_card') }}" 
                        class="w-full bg-[#15171A] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-red-500 transition-colors"
                        required>
