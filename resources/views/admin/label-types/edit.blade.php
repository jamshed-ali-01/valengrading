...
<html>
<head>
    <title>Edit Label Type - Admin Dashboard</title>
    <style>
...
<body>
<div class="container">
    <h1>Edit Label Type: {{ $labelType->name }}</h1>
    
    <form method="POST" action="{{ route('admin.label-types.update', $labelType) }}">
        @csrf
        @method('PUT')
        
        <div class="form-group">
            <label for="name">Label Type Name*</label>
            <input type="text" id="name" name="name" value="{{ old('name', $labelType->name) }}" required>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" min="0" id="price_adjustment" name="price_adjustment" value="{{ old('price_adjustment', $labelType->price_adjustment) }}" required>
        ...
        <div class="form-group">
            ...
            <input type="number" id="order" name="order" value="{{ old('order', $labelType->order) }}" required>
        ...
        <button type="submit" class="btn btn-primary">Update Label Type</button>
